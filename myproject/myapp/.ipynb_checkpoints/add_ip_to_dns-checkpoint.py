...
import json, logging, math, ipaddress, pprint, argparse
...
parser.add_argument("--network", required=True, help="VLAN540, VLAN673, VLAN421")
parser.add_argument("--hostname", required=True, help="fqdm: example.corp.pvt")
parser.add_argument("--mac", required=True, help="mac address")

#    "VLAN540": "ST1 - Weblogic",
#    "VLAN673": "EV3 - Weblogic",
#    "VLAN421": "vlan 421- linux_421"
...
ipstart = ipaddress.IPv4Address(subnet['addr']) + 20
